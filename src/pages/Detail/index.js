...
const message = ' Olá APAD, estou entrando em contato pois gostaria de ajudar no caso "Cadelinha atropelada " com o valor de R$ 120,00 reais'
...
function sendMail() {
  MailComposer.composeAsync({
    ...
    recipients: ["felipe_kid_13@Hotmail.com"],
    body: message,
  });
}
function sendWhatsapp() {
  Linking.openURL(`whatsapp://send?phone=5512992178328& text= ${message}`);
} 
  ...
  return(
    ...
    <Text style={[styles.incedentProperty, {marginTop: 0} ]}> ONG:</Text>
    ...
    <View style={styles.contactBox}>
      ...
      <View style={styles.actions}>
        <TouchableOpacity style={styles.actionbuttonwhats} onPress = {sendWhatsapp} >
